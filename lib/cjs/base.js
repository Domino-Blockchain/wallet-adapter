...
exports.BaseDWalletWalletAdapter = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
const web3_js_1 = require("@solana/web3.js");
class BaseDWalletWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            ...
            if (typeof this._provider === 'string') {
                ...
                (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
                    var _a;
                    if (typeof ((_a = window.dwallet) === null || _a === void 0 ? void 0 : _a.postMessage) === 'function') {
                        console.log(2);
...
exports.BaseDWalletWalletAdapter = BaseDWalletWalletAdapter;
